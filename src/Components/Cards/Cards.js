              ...
              <div className="container-fluid">
                <div id="cordMainRow" className="row shadow bg-white rounded">
                  ...
                  <div className="offset-md-1 col-lg-3">
                    ...
                    <p id="dueBy">
                      Due by : <span id="dueDate">{a.dueBy}</span>
                    </p>
                    <br />
                    <p id="dueBy">
                      Meeting : <span id="dueDate">{a.meeting}</span>
                    </p>
                  </div>

                  <div className="col-lg-1">
                    <button id="high" type="button">
                      High
                    </button>
                  </div>
                  <div id="rightColumn" className="col-lg-4">
                    ...
                    <div id="CardIcons" className="row">
                      ...
                      <div className="col-sm-6">
                        <button id="viewDetails" type="button">
                          View Details
                        </button>
                      </div>
                    </div>
